...

{
    ...
    [SerializeField] float counterHeight;
    ...
    private void Update()
    {
        ...
        if (Physics.Raycast(ray, out hit, collidableLayer))
        {
            ...
            //float height = targetPos.y + targetPos.magnitude / 2f;        // ORIGINAL
            //float height = targetPos.y + extraHeight;                     // MODIFIED

            cachedDistance = targetPos.magnitude;

            float heightMod = targetPos.magnitude;
            //heightMod = Mathf.Min(20f, heightMod);    // OG
            heightMod = Mathf.Min((counterHeight * 3), heightMod);
            //Debug.Log("Magnitude: " + heightMod);


            float height = targetPos.y + (counterHeight - heightMod / 2f);
    ...
    {
        float ratio = timeElapsed / cachedDistance;
        //float answer = cachedDistance / timeElapsed;

        Debug.Log("Ratio:   " + ratio);
        //Debug.Log("Ratio_2: " + answer);
    }
